...
/***                            GPX                                ***/
/*** Demo 7 is based on demo 5 with more complicated default rules ***/
/*** The default rules has 'if-statements' to control packet flows ***/
