...
// GPX test equvilent data types
typedef bit<9> egressSpecGPX_t;
...
control MyIngress(inout headers hdr,
	...
	egressSpecGPX_t newPort = port;			// GPX equvelent type middle variable
        standard_metadata.egress_spec = newPort;	// GPX equvelent types
...
/**************************** GPX ***************************************/
/******* 04 Adding all match tables modify metadata and modify back *****/
/******* 004 Metadata: Egress port +511 and -511 within one action **********/
